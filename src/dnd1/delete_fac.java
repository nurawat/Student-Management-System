 ...
 * @author shubham
 */
public class delete_fac extends javax.swing.JFrame {

    /**
     * Creates new form delete_fac
     */
    public delete_fac() {
        initComponents();
    }
...
this.setVisible(false);
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        ...
        try {
            ...
            String query = "delete from fac where username=";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(delete_fac.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new delete_fac().setVisible(true);
            }
        });
    }
